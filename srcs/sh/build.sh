...
then
    ...
    docker build -t my-grafana srcs/grafana/ > /dev/null ; echo -n ...
    docker build -t my-influxdb srcs/influxdb/ > /dev/null ; echo -n ...
    docker build -t my-telegraf srcs/telegraf/ > /dev/null ;echo "...\033[0m \033[1;32mDone ✔\033[0m\n"
fi